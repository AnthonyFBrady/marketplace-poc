...
const PHOTOS = {
  ...
  canoe: [
    "https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1531722569936-825d4ecd6355?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1565967511849-76a60a516170?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&q=80&fit=crop",
  ],
  circularSaw: [
    "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1572981779307-38b8cabb2407?w=800&q=80&fit=crop",
  ],
  carpetCleaner: [
    "https://images.unsplash.com/photo-1527515545081-5db817172677?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1563453392212-326f5e854473?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80&fit=crop",
  ],
  generator: [
    "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1609770231080-e321deccc34c?w=800&q=80&fit=crop",
  ...
  projector: [
    ...
    "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1626379616077-bb4f9ddb5db0?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1524253482453-3fed8d2fe12b?w=800&q=80&fit=crop",
  ],
  djController: [
    "https://images.unsplash.com/photo-1571330735066-03aaa9429d89?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1619983081563-430f63602796?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1504704911898-68304a7d2807?w=800&q=80&fit=crop",
  ],
  drumKit: [
    "https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1574672280600-4accfa5b6f98?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1543443258-92b04ad5ec6b?w=800&q=80&fit=crop",
  ],
  roadBike: [
    "https://images.unsplash.com/photo-1558618047-f4e90bb98b2e?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1507035895480-2b3156c31fc8?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1502764613149-7f1d229e230f?w=800&q=80&fit=crop",
    "https://images.unsplash.com/photo-1537151608828-ea2b11777ee8?w=800&q=80&fit=crop",
  ],
};
...
export const LISTINGS: Listing[] = [
  ...
  {
    id: "16",
    slug: "old-town-canoe-king-west",
    title: "Old Town 16ft Penobscot canoe + 2 paddles + PFDs",
    category: "camping",
    description:
      "Old Town Penobscot 16, royalex hull. We've paddled this on Algonquin lakes, the Humber River, and the Credit. Stable and forgiving — good for beginners. Comes with two wood shaft paddles and two adult PFDs. You'll need a roof rack and someone to help lift it (65 lbs). I have foam saddles and cam straps you can borrow.",
    photos: PHOTOS.canoe,
    dailyRate: 65,
    weeklyRate: 260,
    deposit: 120,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[0],
          rating: 5,
          text: "Took this on the Humber with my daughter. Incredibly stable and James gave us a perfect paddling route.",
          date: "July 2025",
        },
        {
          author: "Aisha",
          avatar: REVIEWER_AVATARS[1],
          rating: 5,
          text: "First time canoeing. James was patient with technique tips. The canoe is in great shape.",
          date: "June 2025",
        },
      ],
    },
    rules: [
      "Roof rack required — does not fit in a sedan",
      "PFDs must be worn on moving water",
      "Rinse hull before returning",
    ],
    cancellationPolicy: "moderate",
    availableWeekends: true,
    popularThisWeek: false,
  ...
  {
    id: "17",
    slug: "dewalt-circular-saw-leslieville",
    title: "DeWalt 7-1/4 inch circular saw + rafter square + clamps",
    category: "tools",
    description:
      "DeWalt DWE575SB, 15-amp circular saw with electric brake and dust blower. Clean cuts in framing lumber, plywood, and OSB. Used for building my deck last summer. Comes with a speed square, two F-clamps, and a fresh 24-tooth blade. Perfect for framing, decking, or sheet goods. Extension cord not included — bring 12-gauge.",
    photos: PHOTOS.circularSaw,
    dailyRate: 30,
    weeklyRate: 120,
    deposit: 60,
    lat: 43.6680,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[2],
          rating: 5,
          text: "Built a raised garden bed in an afternoon. Saw was sharp, Marcus was easy to deal with.",
          date: "May 2025",
        },
        {
          author: "Nadia",
          avatar: REVIEWER_AVATARS[3],
          rating: 5,
          text: "Used this to cut decking boards for a weekend project. Good condition, clean blade.",
          date: "April 2025",
        },
      ],
    },
    rules: [
      "Return blade guard intact",
      "Do not cut masonry, metal, or roofing",
      "Return clean — sawdust off the body",
    ],
    cancellationPolicy: "flexible",
    availableWeekends: true,
    popularThisWeek: false,
  ...
  {
    id: "18",
    slug: "bissell-carpet-cleaner-distillery",
    title: "Bissell ProHeat 2X carpet cleaner — deep clean in a day",
    category: "tools",
    description:
      "Bissell ProHeat 2X Revolution Max Clean. Used twice on my own place, runs perfectly. Great for carpet, upholstery, and area rugs. Includes two cleaning attachments and a full bottle of Bissell formula. Pre-treat bad stains before running it through for best results. I'll walk you through the settings at pickup.",
    photos: PHOTOS.carpetCleaner,
    dailyRate: 40,
    weeklyRate: 160,
    deposit: 60,
    lat: 43.6510,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[4],
          rating: 5,
          text: "Our rug looked brand new after one pass. Priya included enough formula for the whole job.",
          date: "June 2025",
        },
        {
          author: "Mei",
          avatar: REVIEWER_AVATARS[5],
          rating: 4,
          text: "Machine is great. Follow the pre-treatment advice — it made a real difference on our dining room rug.",
          date: "May 2025",
        },
      ],
    },
    rules: [
      "Empty and rinse dirty water tank before returning",
      "Return the formula bottle even if empty",
      "Do not use on hardwood or tile",
    ],
    cancellationPolicy: "flexible",
    availableWeekends: true,
    popularThisWeek: false,
  ...
  {
    id: "19",
    slug: "honda-generator-roncesvalles",
    title: "Honda EU2200i inverter generator — ultra-quiet, 2200W",
    category: "party",
    description:
      "Honda EU2200i, 2200 watts, inverter technology. Whisper quiet at 48-57 dB — it will not disrupt your event. Clean power, safe for sensitive electronics including PA systems, DJ controllers, and projectors. Serviced annually. Includes two 15-amp outlets and a 30-amp RV plug. Gas not included but I have a jerry can you can borrow. Runtime: about 8 hours on a tank.",
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[0],
          rating: 5,
          text: "Ran our PA and projector for a 6-hour outdoor event without a flicker. This generator is genuinely silent.",
          date: "August 2025",
        },
        {
          author: "Sofia",
          avatar: REVIEWER_AVATARS[1],
          rating: 5,
          text: "Exactly as described. Tom walked me through startup and it worked flawlessly all night.",
          date: "July 2025",
        },
      ],
    },
    rules: [
      "No operation indoors or in enclosed spaces — CO risk",
      "Return with oil checked and spark arrestor clean",
      "Return the jerry can full",
    ],
    cancellationPolicy: "strict",
    availableWeekends: true,
    popularThisWeek: true,
  ...
  {
    id: "20",
    slug: "benq-4k-projector-king-west",
    title: "BenQ 4K projector + 100in screen + surround sound",
    category: "electronics",
    description:
      "BenQ TK850 true 4K projector (3000 lumens, HDR), 100-inch motorized screen on a floor stand, and a 5.1 Klipsch surround sound bar system. Great for outdoor movie nights, corporate presentations, or sports watch parties. Full cable bundle included. Setup takes about 45 minutes. I recommend a dark or shaded space for best image quality.",
    photos: PHOTOS.projector,
    dailyRate: 90,
    weeklyRate: 350,
    deposit: 200,
    lat: 43.6435,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[2],
          rating: 5,
          text: "Hosted an outdoor movie night for 30 people. Image was stunning, sound was incredible.",
          date: "August 2025",
        },
        {
          author: "Chris",
          avatar: REVIEWER_AVATARS[3],
          rating: 5,
          text: "Used for a company presentation. Looked completely professional. Daniel was reachable by text the whole time.",
          date: "July 2025",
        },
      ],
    },
    rules: [
      "Handle projector lamp with care — no drops",
      "Screen legs must be protected in transport",
      "Return all cables in the labelled bag",
    ],
    cancellationPolicy: "strict",
    availableWeekends: true,
    popularThisWeek: false,
  ...
  {
    id: "21",
    slug: "pioneer-dj-controller-trinity-bellwoods",
    title: "Pioneer DDJ-400 DJ controller + Serato license",
    category: "electronics",
    description:
      "Pioneer DDJ-400, 2-channel controller designed for Serato DJ Lite. Includes an activated Serato DJ Lite license — laptop not included, bring your own with Serato installed. Great for house parties, rooftop events, and beginner-to-intermediate DJs. Ran this at private events for 3 years. In perfect condition. Includes power adapter and all cables.",
    photos: PHOTOS.djController,
    dailyRate: 70,
    weeklyRate: 280,
    deposit: 150,
    lat: 43.6460,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[4],
          rating: 5,
          text: "Rented for my girlfriend's birthday party. The DDJ-400 is incredibly intuitive and Ana gave a quick setup rundown. Huge hit.",
          date: "June 2025",
        },
        {
          author: "Emma",
          avatar: REVIEWER_AVATARS[5],
          rating: 5,
          text: "Set up in 10 minutes. Remember to have Serato installed before you pick it up.",
          date: "May 2025",
        },
      ],
    },
    rules: [
      "Laptop not included — bring your own with Serato DJ Lite installed",
      "Do not use in rain or high humidity",
      "Handle jog wheels carefully — do not press directly on centre",
    ],
    cancellationPolicy: "moderate",
    availableWeekends: true,
    popularThisWeek: true,
  ...
  {
    id: "22",
    slug: "pearl-drum-kit-distillery",
    title: "Pearl Export 5-piece drum kit — full hardware + cymbals",
    category: "instruments",
    description:
      "Pearl Export 5-piece kit in jet black: 22in kick, 10/12in toms, 16in floor tom, 14in snare. Includes 14in hi-hat pair, 16in crash, 20in ride, hi-hat stand, two boom cymbal stands, snare stand, kick pedal, and drum throne. Everything is tuned and in great condition. First floor access in the Distillery District. You will need a van or SUV to transport a full kit.",
    photos: PHOTOS.drumKit,
    dailyRate: 60,
    weeklyRate: 240,
    deposit: 150,
    lat: 43.6505,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[0],
          rating: 5,
          text: "Rented for a weekend rehearsal. Kit was in perfect condition and tuned well. James is easy to deal with.",
          date: "May 2025",
        },
        {
          author: "Fatima",
          avatar: REVIEWER_AVATARS[1],
          rating: 4,
          text: "Good kit for the price. Bring a van — it does not fit in a sedan even disassembled.",
          date: "April 2025",
        },
      ],
    },
    rules: [
      "Van or SUV required for transport",
      "No outdoor use — moisture warps the shells",
      "Return all hardware and stands as received",
    ],
    cancellationPolicy: "moderate",
    availableWeekends: false,
    popularThisWeek: false,
  ...
  {
    id: "23",
    slug: "trek-road-bikes-leslieville",
    title: "Two Trek Domane AL 3 road bikes — 52cm + 56cm",
    category: "sports",
    description:
      "Two 2022 Trek Domane AL 3 road bikes: one 56cm (fits 5'9-6'2) and one 52cm (fits 5'5-5'9). Both professionally fitted and tuned. Aluminum frames, carbon fork, Shimano Claris 16-speed. Saddle bags include a spare tube, tire levers, and a mini-pump. Flat pedals fitted — bring your own cleats if you prefer clips. Helmets not included.",
    photos: PHOTOS.roadBike,
    dailyRate: 50,
    weeklyRate: 200,
    deposit: 200,
    lat: 43.6685,
      ...
      reviews: [
        {
          ...
          avatar: REVIEWER_AVATARS[2],
          rating: 5,
          text: "Spent the day riding the Waterfront Trail with a friend. Both bikes were great. The spare tube kit saved us.",
          date: "July 2025",
        },
        {
          author: "Lena",
          avatar: REVIEWER_AVATARS[3],
          rating: 4,
          text: "Great bikes, well maintained. Confirm which size you need before pickup.",
          date: "June 2025",
        },
      ],
    },
    rules: [
      "Helmets required — not provided, bring your own",
      "Lock bikes when not in use — locks not included",
